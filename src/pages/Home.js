...
function Home() {
  ...
  const [shortenedLinks, setShortenedLinks] = useState(
    getSessionStorageOrDefault("ssLinks", [])
  );
          ...
          <div className="dark-section">
            <div className="container">
                  ...
                  <div className="form">
                    <div>
                      <input
                        ...
                        ref={inputOutline}
                      />
                      <p className="error-msg-para" ref={errorPara}>
                        {errorMsg}
                      </p>
                    </div>
                    <button
              ...
              <section className="statistics-wrapper">
                <div>
                  <h2 className="fs-secondary-heading fc-secondary-heading-dark">
                    Advanced Statistics
                  </h2>
                  <p>
        ...
        <section>
          <div className="cta-section">
            ...
            <div className="cta-section-content">
              <h2 className="fs-secondary-heading fc-secondary-heading-white">
